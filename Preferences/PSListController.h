...
@property(assign, nonatomic) BOOL forceSynchronousIconLoadForCreatedCells;	// @synthesize=_forceSynchronousIconLoadForCreatedCells
@property(retain) NSString* specifierID;	// converted property
@property(retain) NSArray* specifiers;	// converted property
@property(retain) id specifier;	// converted property
@property(readonly, retain) UITableView* table;	// converted property
@property(readonly, retain) UIPopoverController* popupStylePopoverController;	// converted property
@property(readonly, assign) float verticalContentOffset;	// converted property
+(BOOL)displaysButtonBar;
// declared property setter: -(void)setForceSynchronousIconLoadForCreatedCells:(BOOL)createdCells;
// declared property getter: -(BOOL)forceSynchronousIconLoadForCreatedCells;
...
// converted property getter: -(float)verticalContentOffset;
...
// converted property getter: -(id)specifierID;
// converted property setter: -(void)setSpecifierID:(id)anId;
...
// converted property setter: -(void)setSpecifiers:(id)specifiers;
...
// converted property getter: -(id)specifiers;
...
-(void)clearCache;
// converted property getter: -(id)popupStylePopoverController;

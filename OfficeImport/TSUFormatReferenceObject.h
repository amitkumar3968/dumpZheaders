...
@interface TSUFormatReferenceObject : XXUnknownSuperclass {
@private
	struct {
		int mFormatType;
		union {
...
-(XXStruct_M$PztB)getFormatStruct;
-(id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;
-(id)init;
@end
